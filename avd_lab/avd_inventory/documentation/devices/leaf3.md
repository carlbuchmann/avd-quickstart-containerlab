...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.123.23/24 | 192.168.123.1 |
...
| --------- | --------------- | ------------ | --------- |
| pod1 | Vlan4094 | 10.255.252.5 | Port-Channel511 |
...
| Ethernet51/1 | MLAG_PEER_leaf4_Ethernet51/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
| Ethernet52/1 | MLAG_PEER_leaf4_Ethernet52/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
...
| Port-Channel511 | MLAG_PEER_leaf4_Po511 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| Vlan3009 |  TEST_VRF  |  10.255.251.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TEST_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
