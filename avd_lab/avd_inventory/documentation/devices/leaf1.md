...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.123.21/24 | 192.168.123.1 |
...
| --------- | --------------- | ------------ | --------- |
| pod0 | Vlan4094 | 10.255.252.1 | Port-Channel511 |
...
| Ethernet51/1 | MLAG_PEER_leaf2_Ethernet51/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
| Ethernet52/1 | MLAG_PEER_leaf2_Ethernet52/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
...
interface Ethernet51/1
   description MLAG_PEER_leaf2_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_PEER_leaf2_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| Port-Channel511 | MLAG_PEER_leaf2_Po511 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel511
   description MLAG_PEER_leaf2_Po511
   no shutdown
   switchport
...
| Vlan3009 |  TEST_VRF  |  10.255.251.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TEST_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
