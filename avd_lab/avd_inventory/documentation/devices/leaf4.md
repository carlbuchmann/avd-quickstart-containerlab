...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.123.24/24 | 192.168.123.1 |
...
| --------- | --------------- | ------------ | --------- |
| pod1 | Vlan4094 | 10.255.252.4 | Port-Channel511 |
...
| Ethernet51/1 | MLAG_PEER_leaf3_Ethernet51/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
| Ethernet52/1 | MLAG_PEER_leaf3_Ethernet52/1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 511 |
...
interface Ethernet51/1
   description MLAG_PEER_leaf3_Ethernet51/1
   no shutdown
   channel-group 511 mode active
!
interface Ethernet52/1
   description MLAG_PEER_leaf3_Ethernet52/1
   no shutdown
   channel-group 511 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel11 | host21_leaf3_to_host21 | switched | access | 200 | - | - | - | - | 11 | - |
| Port-Channel12 | host22_leaf3_to_host22 | switched | access | 150 | - | - | - | - | 12 | - |
| Port-Channel511 | MLAG_PEER_leaf3_Po511 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel511
   description MLAG_PEER_leaf3_Po511
   no shutdown
   switchport
...
| Vlan3009 |  TEST_VRF  |  10.255.251.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TEST_VRF | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
